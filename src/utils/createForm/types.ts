...
export type IFuncComponents<T = Record<string, any>> = (form: FormInstance) => Array<IComponent<T>>;
export type IComponentsConfig<T = any> = IFuncComponents<T> | Array<IComponent<T>>;
